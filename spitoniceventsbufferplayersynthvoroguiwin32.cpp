...
#include "stdafx.h"
#include "spitoniceventsbufferplayersynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitoniceventsbufferplayersynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitoniceventsbufferplayersynthvoroguiwin32class"};				// the main window class name
